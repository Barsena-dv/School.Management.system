...
const { getStudentAnalytics, getAdminOverview, getTeacherOverview, getLoggedInStudentAnalytics } = require("../controllers/analytics.controller");
...
router.get("/student", verifyToken, authorizeRoles("student"), getLoggedInStudentAnalytics);
