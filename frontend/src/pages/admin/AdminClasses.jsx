        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="bg-surface w-full max-w-sm rounded-lg shadow-2xl p-6 space-y-5">
                <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-lg font-bold text-text-primary">Delete Class?</h3>
    ...
    return (
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-border">
                <div>
                    <h1 className="text-xl font-bold font-heading text-text-primary tracking-tight">Classes</h1>
                    <p className="text-text-muted mt-1 font-medium">Manage all class groups and sections.</p>
                </div>
                <button onClick={openCreate}
                    className="inline-flex items-center gap-2 px-5 py-3 bg-neutral-900 text-white text-sm font-bold rounded-lg hover:bg-neutral-800 transition-colors shadow-sm flex-shrink-0">
                ...
                {loading ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y divide-border">
                                {filtered.map(cls => (
                                    <tr key={cls._id} className="hover:bg-bg-subtle/30 transition-colors group">

                                        {/* Grade */}
                                        <td className="px-5 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 rounded-lg bg-primary-subtle border border-primary/20 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-100 transition-colors">
                                                    <GraduationCap size={15} className="text-primary" />
                                                </div>
                                                <span className="text-sm font-bold text-text-primary">{cls.grade}</span>
                                            </div>
                                        </td>

                                        {/* Section */}
                                        <td className="px-5 py-4">
                                            <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-bg-subtle text-neutral-700 text-xs font-bold border border-border">
                                                {cls.section}
                                            </span>
                                        </td>
                                        ...
                                        {/* Academic Year */}
                                        <td className="px-5 py-4">
                                            <span className="text-sm text-text-secondary font-medium">{cls.academicYear}</span>
                                        </td>
