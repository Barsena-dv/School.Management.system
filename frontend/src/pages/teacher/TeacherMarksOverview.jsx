...
const TeacherMarksOverview = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto py-6 px-4">
            <SectionHeader 
                title="Grade Assignments & Assessments" 
                description="Select a subject to view submissions and record marks" 
            />
            ...
            {loading ? (
                ...
                <div className="surface shadow-sm rounded-lg p-12 text-center border border-border mt-8">
                    ...
                    <p className="text-sm text-text-secondary mt-2">You must be assigned to a subject before you can grade marks.</p>
                </div>
            ) : (
...
export default TeacherMarksOverview
